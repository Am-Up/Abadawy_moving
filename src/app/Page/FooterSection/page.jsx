          ...
          <div className="text-center md:text-start md:w-3/12 ">
            ...
            <div className="flex gap-4 justify-center md:justify-start">
              <button
                variant="outline"
                size="sm"
                className="border-gray-600 rounded-[4px] text-gray-300 hover:bg-blue-600 hover:border-blue-600"
              >
              ...
              <button
                variant="outline"
                size="sm"
                className="border-gray-600 rounded-[4px] text-gray-300 hover:bg-blue-400 hover:border-blue-400"
              >
              ...
              <button
                variant="outline"
                size="sm"
                className="border-gray-600 rounded-[4px] text-gray-300 hover:bg-pink-600 hover:border-pink-600"
              >
